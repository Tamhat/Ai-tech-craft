...
const JoinOurTeam = () => {
  return (
    <section className='joinTeam__bg'>
        <div className="container joinTeam__container">
            ...
            <div className="joinTeam__right">
                <img src="https://comradeweb.com/wp-content/webp-express/webp-images/doc-root/wp-content/uploads/2022/06/IMG_2983-2-1-1024x687.jpg.webp" alt="" />
            </div>
        </div>
    </section>
  )
